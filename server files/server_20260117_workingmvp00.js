...
<head>
    ...
    <style>
        * {
        ...
        button {
            padding: 12px 24px;
            background: linear-gradient(135deg, #4ba288ff 0%, #5055e8ff 100%);
            color: white;
            border: none;
            border-radius: 8px;
            font-size: 15px;
...
<body>
    <div class="container">
        ...
        <div class="input-section">
            ...
            <button id="fetchBtn">Fetch Approvals</button>
        </div>
        ...
        <div class="loader" id="loader">
            ...
            <p style="margin-top: 10px; color: #666; font-size: 14px;">Fetching approvals...</p>
        </div>
